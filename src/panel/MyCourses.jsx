...
// src/panel/MyCourses.jsx - CORREGIDO COMPLETAMENTE
import React, { useState, useEffect } from 'react'
import { useNavigate } from 'react-router-dom'
import Layout from '../utils/Layout'
import { useAuth } from '../utils/AuthContext'
...
const MyCourses = () => {
    ...
    const goToCourse = (curso) => {
        // ✅ CORREGIDO: Usar ID en lugar de slug
    ...
    const goToCourseProgress = (curso) => {
        // Navegar al progreso detallado del curso usando ID
        const cursoId = curso.curso_id || curso.id
        if (!cursoId) {
            console.error('No se encontró ID del curso:', curso)
            return
