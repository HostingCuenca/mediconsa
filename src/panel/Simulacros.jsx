//
// // src/panel/Simulacros.jsx - VERSIÓN CONCISA
...
//         <Layout showSidebar={true}>
//             <div className="p-6">
//                 <h1 className="text-2xl font-bold mb-6">Simulacros</h1>
//
//                 {/* Tabs */}
//                 <div className="flex space-x-1 bg-gray-100 rounded-lg p-1 mb-6">
//                     <button
//                         onClick={() => setActiveTab('available')}
//                         className={`px-4 py-2 rounded-md ${activeTab === 'available' ? 'bg-white shadow' : ''}`}
//                     >
//                         Disponibles ({availableSimulacros.length})
//                     </button>
//                     <button
//                         onClick={() => {setActiveTab('attempts'); loadData()}}
//                         className={`px-4 py-2 rounded-md ${activeTab === 'attempts' ? 'bg-white shadow' : ''}`}
//                     >
...
//                             <div key={simulacro.id} className="bg-white p-6 rounded-lg shadow border">
//                                 <div className="mb-4">
//                                     <h3 className="font-semibold text-lg mb-2">{simulacro.titulo}</h3>
//                                     <p className="text-blue-600 text-sm">{simulacro.curso_titulo}</p>
//                                     <span className={`inline-block px-2 py-1 rounded text-xs mt-2 ${
//                                         simulacro.modo_evaluacion === 'practica' ? 'bg-blue-100 text-blue-800' :
//                                             simulacro.modo_evaluacion === 'realista' ? 'bg-yellow-100 text-yellow-800' :
//                                                 'bg-red-100 text-red-800'
//                                     }`}>
//                                         {simulacro.modo_evaluacion}
//                                     </span>
//                                 </div>
//
//                                 <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
//                                     <div className="text-center p-2 bg-gray-50 rounded">
//                                         <div className="font-semibold">{simulacro.numero_preguntas}</div>
...
//                                     <span>Intentos: {simulacro.intentos_realizados || 0}</span>
...
//                                     >
//                                         {simulacro.intentos_realizados > 0 ? 'Repetir' : 'Iniciar'}
//                                     </button>
//                                 ) : (
//                                     <div className="w-full bg-gray-100 text-gray-500 py-2 rounded text-center">
...
//                             <div key={intento.id} className="bg-white p-6 rounded-lg shadow border">
//                                 <div className="flex justify-between items-start">
//                                     <div>
//                                         <h3 className="font-semibold">{intento.simulacro_titulo}</h3>
//                                         <p className="text-blue-600 text-sm">{intento.curso_titulo}</p>
//                                         <p className="text-gray-500 text-sm">
//                                             {new Date(intento.fecha_intento).toLocaleString()}
//                                         </p>
//                                     </div>
//                                     <div className="text-right">
//                                         <div className={`text-2xl font-bold ${
//                                             intento.puntaje >= 80 ? 'text-green-600' :
//                                                 intento.puntaje >= 60 ? 'text-yellow-600' : 'text-red-600'
//                                         }`}>
//                                             {intento.puntaje}%
//                                         </div>
//                                         <div className="text-sm text-gray-600">
//                                             {intento.respuestas_correctas}/{intento.total_preguntas}
//                                         </div>
//                                     </div>
//                                 </div>
//                             </div>
...
//                         <p className="text-gray-500 mb-4">No hay simulacros disponibles</p>
//                         <button
...
//                     <div className="text-center py-12">
//                         <p className="text-gray-500">No has realizado simulacros aún</p>
//                     </div>
//                 )}
//             </div>
//         </Layout>
...
// src/panel/Simulacros.jsx - ACTUALIZADO CON COMPATIBILIDAD
import React, { useState, useEffect } from 'react'
import { useNavigate } from 'react-router-dom'
import Layout from '../utils/Layout'
import { useAuth } from '../utils/AuthContext'
