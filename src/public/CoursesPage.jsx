...
const CoursesPage = () => {
    ...
    const handleInteresClick = (curso) => {
        const mensaje = `Hola! Me interesa el ${curso.titulo}.`
        const whatsappUrl = `https://wa.me/593985036066?text=${encodeURIComponent(mensaje)}`
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="bg-gradient-to-r from-medico-blue to-blue-700 rounded-2xl p-8 text-center text-white">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <a
                                    href="https://wa.me/593985036066?text=Hola!%20Me%20gustar%C3%ADa%20recibir%20asesor%C3%ADa%20sobre%20sus%20cursos%20disponibles."
                                    target="_blank"
