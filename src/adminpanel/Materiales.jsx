...
//             }
//
//             if (!createForm.archivoUrl.trim()) {
//                 setError('La URL del archivo es requerida')
//                 return
//             }
//
...
//                 archivoUrl: createForm.archivoUrl.trim(),
...
//             navigate(`/admin/course/${material.curso_id}`)
//         } else {
...
//                     <div>
//                         <h1 className="text-3xl font-bold text-medico-blue mb-2">Gestión de MyMateriales</h1>
...
//                                         </button>
//                                         <button
//                                             onClick={() => handleDeleteMaterial(material.id, material.titulo)}
...
//                                             disabled={saving || !createForm.titulo.trim() || !createForm.archivoUrl.trim()}
//                                         >
//                                             {saving ? (
//                                                 <>
