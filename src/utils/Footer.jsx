    ...
    return (
        <footer className="bg-white border-t border-gray-200 mt-auto">
            ...
            <div>
                ...
                <ul className="space-y-2">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            {/*<li>*/}
                            {/*    <a href="mailto:soporte@mediconsa.com"*/}
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                    <h3 className="text-medico-blue font-semibold mb-4">Síguenos en nuestras redes sociales</h3>
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 text-medico-gray hover:text-medico-blue transition-colors group"
            >
