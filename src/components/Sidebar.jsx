            ...
            <div className="p-4">
                ...
                <div className="mt-8">
                    ...
                    <div className="space-y-2">
                        <a
                            href="https://wa.me/59398503606?text=Hola, necesito soporte técnico en Mediconsa"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center space-x-2 text-medico-green hover:text-green-700 text-sm transition-colors"
                        >
