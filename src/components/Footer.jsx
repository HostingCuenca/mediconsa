                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-medico-gray text-sm max-w-md">
                            Plataforma líder en preparación médica para CACES, SENESYCT y exámenes de especialización.
                            Prepárate con los mejores contenidos y simulacros especializados.
                        </p>

                        {/* WhatsApp Contact */}
                        <div className="mt-4">
                            <a
                                href="https://wa.me/59398503606?text=Hola, necesito información sobre los cursos de Mediconsa"
                                target="_blank"
                            ...
                            >
                                ...
                                <span className="text-sm font-medium">+593 98 503 6066</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <Link to="/cursos" className="text-medico-gray hover:text-medico-blue text-sm transition-colors">
                                    Todos los Cursos
                                </Link>
                            </li>
                            <li>
                                <Link to="/cursos?tipo=caces" className="text-medico-gray hover:text-medico-blue text-sm transition-colors">
                                    Preparación CACES
                                </Link>
                            </li>
                            <li>
                                <Link to="/cursos?tipo=senesyct" className="text-medico-gray hover:text-medico-blue text-sm transition-colors">
                                    Exámenes SENESYCT
                                </Link>
                            </li>
                            <li>
                                <Link to="/cursos?tipo=rural" className="text-medico-gray hover:text-medico-blue text-sm transition-colors">
                                    Medicina Rural
                                </Link>
                            </li>
                        </ul>
                ...
                <div className="border-t border-gray-200 pt-6 mt-8">
                    <div className="flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
                        ...
                        <p className="text-medico-gray text-sm">
                            ...
                            {' '} |{' '}
                            <a
                                href="https://wa.me/59398503606?text=Hola, vi su trabajo en Mediconsa y me interesa sus servicios de desarrollo"
                                target="_blank"
                                rel="noopener noreferrer"
