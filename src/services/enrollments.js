...
//
//     // =============================================
//     // MÉTODOS DE FILTRADO ESPECÍFICOS PARA ADMIN
//     // =============================================
//
//     // Obtener todas las inscripciones habilitadas
//     async getAllActiveEnrollments(filters = {}) {
//         return await this.getAllEnrollments({ ...filters, estado: 'habilitado' })
//     }
//
//     // Obtener todas las inscripciones pendientes
//     async getAllPendingEnrollments(filters = {}) {
//         return await this.getAllEnrollments({ ...filters, estado: 'pendiente' })
//     }
//
//     // Obtener inscripciones de cursos gratuitos
//     async getAllFreeEnrollments(filters = {}) {
//         // Nota: esto requerirá filtrar en el frontend por es_gratuito
//         return await this.getAllEnrollments(filters)
//     }
//
//     // Obtener inscripciones de cursos pagados
//     async getAllPaidEnrollments(filters = {}) {
//         // Nota: esto requerirá filtrar en el frontend por es_gratuito
//         return await this.getAllEnrollments(filters)
//     }
//
